package ru.gb.lesson5.views;

import ru.gb.lesson5.models.Table;
import ru.gb.lesson5.presenters.View;
import ru.gb.lesson5.presenters.ViewObserver;
...
public class BookingView implements View {
    ...
    /**
     * Действие клиента (пользовател нажал на кнопку бронирования), бронирование столика
    ...
    public void changeReservationTable(int oldReservation, Date reservationDate, int tableNo, String name) {
        if (observer != null)
            observer.newChangedReservationTable(oldReservation, reservationDate, tableNo, name);
    }
}
